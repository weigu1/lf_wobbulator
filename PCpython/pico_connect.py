...
def scan_for_picos(verbose = False):
    ...
    return picos
#-----------------------------------------------------------------
def get_info_pico_by_import(pico, timeout):
    ''' OLD METHOD, DEPRECATED
        Get info stored on the pico in a file info.py
        This must contain a function info defined like this:
        def info():
            print( "SINGEN")
        For this example the keyword "SINGEN" would be returned    
    '''
